...
#
. "/opt/tomshley/provisioning/tools/cicd/gitlab/scripts/bin/cicd-exports.sh"
. "/opt/tomshley/provisioning/tools/cicd/gitlab/scripts/bin/cicd-bootstrap-envvars-gitlab.sh"

cd "${CI_PROJECT_DIR}" || exit

. "/opt/tomshley/provisioning/tools/cicd/gitlab/scripts/bin/cicd-bootstrap-gitlab-gitconfig.sh"
. "/opt/tomshley/provisioning/tools/cicd/gitlab/scripts/bin/cicd-flow-release-publish-prep.sh"
